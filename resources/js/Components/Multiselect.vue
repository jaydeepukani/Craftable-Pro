    ...
    >
      ...
      >
        ...
        <template #singlelabel="{ value }">
          <div
            class="multiselect-single-label text-gray-800 text-sm w-full truncate"
          >
...
const props = withDefaults(defineProps<Props>(), {
  ...
  delay: -1,
  filterResults: true,
  noOptionsText: wTrans("craftable-pro", "The list is empty").value,
  noResultsText: wTrans("craftable-pro", "No results found").value,
});
